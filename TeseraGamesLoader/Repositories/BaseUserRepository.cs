...
namespace TeseraGamesLoader.Repositories
{
    internal class BaseUserRepository : BaseRepository
    {
        ...
        protected void GetUserDataFromTesera(User user)
        {
            ...
            var ownGameIds = GetGameIdsFromUserData(userOwnData);
            ...
            var wantsGameIds = GetGameIdsFromUserData(userWantsData);
        ...
        protected IEnumerable<string> GetGameIdsFromUserData(string userData)
        {
            IHtmlDocument document;
            lock (_parserLock)
            {
                document = _parser.Parse(userData);
            }
